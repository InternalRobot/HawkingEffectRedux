package com.THE {
	...
	public class FileController {
		...
		public function generateFile(e:Event):void{
			...
			//write bitmap data
			//var bitmapData = new BitmapData(960,500);
			var bitmapData = new BitmapData(theStage.stageWidth,theStage.stageHeight);
			bitmapData.draw(theStage, null, null, null, null);
			...
			var targetFile : File = File.desktopDirectory.resolvePath("images/" + hash + "_twitter.jpg");
